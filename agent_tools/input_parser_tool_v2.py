...
from typing import Type, List, Optional #version 2 added Optional
...
class AirQualityAnalysisInput(BaseModel):
    ...
    author: Optional[str] = Field(None, description="Name of the person generating the report. Defaults to 'Automated AI' if not provided.") #version 2 updates
...
class InputParserTool(BaseTool):
    ...
    def _run(self, locations: List[str], start_date: str, end_date: str, aq_parameters: List[str], author: str) -> str: #Version 2
        """
        ...
        input_summary = {
            ...
            "author" : author or "Report generated by Cloudera Agentic AI" , #version 2 update       
