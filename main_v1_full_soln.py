...
# Note LAB WORK Begins here: Enter the details from the Lab Guide
    ...
    def _setup_tasks(self):
        ...
        parse_user_input_task = Task(
            ...
            expected_output=(
                "A dictionary containing parsed 'locations', 'start_date', 'end_date', and 'aq_parameters' from the user input." #Lab Work : Enter Details here from LAB Guide,
            ),
        )
